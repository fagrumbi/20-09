<template>
  <main>
        ...
        <div class="fixed inset-0 flex">
          <div class="relative mr-16 flex w-full max-w-xs flex-1">
            <div class="absolute left-full top-0 flex w-16 justify-center pt-5">
              <button type="button" class="-m-2.5 p-2.5" @click="isOpen = false">
                  ...
                  <li>
                    <ul role="list" class="-mx-2 space-y-1">
                      <li>
                        ...
                        <nuxt-link to="/user/dashboard" @click.native="isOpen = false"
                      ...
                      <li>
                        <nuxt-link to="/user/dashboard/withdrawals" @click.native="isOpen = false"
                      ...
                      <li>
                        <nuxt-link to="/user/dashboard/deposits" @click.native="isOpen = false"
                          class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                          <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <ul role="list" class="flex flex-1 flex-col gap-y-7">
              <li>
                <ul role="list" class="-mx-2 space-y-1">
                  ...
                  <li>
                    <nuxt-link to="/user/dashboard/withdrawals"
                      class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                      <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round"
                  ...
                  <li>
                    <nuxt-link to="/user/dashboard/deposits"
                      class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                      <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round"
                  ...
                  <li>
                    <nuxt-link to="/user/dashboard/profile-update"
                      class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                      <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="fixed bottom-0 right-0 m-4 z-50">
      <a href="https://wa.me/+447465803771" target="_blank">
        <img src="@/assets/icons/whatsapp.svg" class="text-green-500 h-16 w-16" />
      </a>
    </div>
  </main>
</template>
