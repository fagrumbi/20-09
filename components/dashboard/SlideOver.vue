<template>
  <div class="relative z-50" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
    ...
    <div class="fixed inset-0 overflow-hidden z-50" v-if="showSideOver">
            ...
            <form class="flex h-full flex-col divide-y divide-gray-200 bg-white shadow-xl">
              <div class="h-0 flex-1 overflow-y-auto">
                <div class="bg-indigo-700 px-4 py-6 sm:px-6">
                  ...
                  <div class="mt-1">
                    <p class="text-sm text-indigo-300">Get started by filling in the information below to create your
                      new project.</p>
                  </div>
                </div>
                        ...
                        <div class="mt-2 space-y-4">
                          <div class="relative flex items-start">
                            <div class="absolute flex h-6 items-center">
                              <input id="privacy-public" name="privacy" aria-describedby="privacy-public-description"
                            ...
                            <div class="pl-7 text-sm leading-6">
                              ...
                              <p id="privacy-public-description" class="text-gray-500">Everyone with the link will see
                                this project.</p>
                            </div>
                          </div>
                          <div>
                            <div class="relative flex items-start">
                              ...
                              <div class="pl-7 text-sm leading-6">
                                <label for="privacy-private-to-project" class="font-medium text-gray-900">Private to
                                  project members</label>
                                <p id="privacy-private-to-project-description" class="text-gray-500">Only members of
                          ...
                          <div>
                            <div class="relative flex items-start">
                              ...
                              <div class="pl-7 text-sm leading-6">
                                ...
                                <p id="privacy-private-description" class="text-gray-500">You are the only one able to
                    ...
                    <div class="pb-6 pt-4">
                      <div class="flex text-sm">
                        <a href="#"
                          ...
                          <svg class="h-5 w-5 text-indigo-500 group-hover:text-indigo-900" viewBox="0 0 20 20"
