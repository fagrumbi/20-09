      ...
      <div
        ...
        <div class="lg:pr-4">
          <div class="lg:max-w-lg">
            ...
            <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Get €300* With a Checking
              Account Built for You
            </h1>
            <p class="mt-6 text-xl leading-8 text-gray-700">For a limited time, get a €300 when you open any new
              checking account! *Select "Learn More" to see important offer details.</p>
          </div>
        </div>
      </div>
      <div class="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
        <img class="w-[48rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem]"
          src="@/assets/img/man-smiling.jpeg" alt="">
      </div>
    </div>
  </div>
